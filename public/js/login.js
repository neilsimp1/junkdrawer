$(document).ready(function(){
	...
	$('.loginreg').on('click', function(){
		...
		var span_loginregister = document.getElementById('span_loginregister');
	...
	switch(window.location.hash){
		case 'login': document.getElementById('span_login').click(); break;
		case 'register': document.getElementById('span_register').click(); break;
	}
